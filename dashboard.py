...
subtitleLabel=Label(window,text='Welcome Admin \t\t Date:06-02-2025 \t\t Time:12:36 pm',font=('times new roman',15),bg='#4d636d',fg='white')
...
imageLabel.pack()
menuLabel=Label(leftFrame,text='Menu',font=('tiems new roman',20),bg='#009688')
...
pod_frame=Frame(window,bg='#2C3E50',bd=3,relief=RIDGE)
pod_frame.place(x=800,y=310,height=170,width=280)
total_pod_icon=PhotoImage(file='total_prod.png')
total_pod_icon_label=Label(pod_frame,image=total_pod_icon,bg='#2C3E50')
total_pod_icon_label.pack(pady=10)
total_pod_label=Label(pod_frame,text='Total Products',bg='#2C3E50',fg='white',font=('times new roman',15,'bold'))
total_pod_label.pack()
total_pod_count_label=Label(pod_frame,text='0',bg='#2C3E50',fg='white',font=('times new roman',30,'bold'))
total_pod_count_label.pack()
